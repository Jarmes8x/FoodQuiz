...
const ingredients = [
  ...
  { name: 'กระเทียม', price: 5, image_file: '13.png' },
  { name: 'พริก', price: 5, image_file: '14.png' },
  { name: 'มะเขือเทศ', price: 5, image_file: '16.png' },
  { name: 'หอม', price: 5, image_file: '17.png' },
  { name: 'ไข่', price: 5, image_file: '20.png' },
  { name: 'กุ้ง', price: 5, image_file: '21.png' },
  { name: 'มะนาว', price: 5, image_file: '12.png' },
  { name: 'ต้นหอม', price: 5, image_file: '18.png' },
  { name: 'ผักกาด', price: 5, image_file: '19.png' },
  { name: 'ฟักทอง', price: 5, image_file: '25.png' },
  { name: 'เห็ด', price: 5, image_file: '23.png' },
  { name: 'ใบกะเพรา', price: 5, image_file: '15.png' }, 
  { name: 'ใบโหระพา', price: 5, image_file: '26.png' } ,
  { name: 'แครอท', price: 5, image_file: '24.png' }, 
  { name: 'ไก่', price: 5, image_file: '22.png' },
  { name: 'หอมแดง', price: 5, image_file: '28.png' },
  { name: 'ข้าว', price: 5, image_file: '29.png' },
  { name: 'แตงกวา', price: 5, image_file: '30.png' },
  { name: 'มะละกอ', price: 5, image_file: '31.png' }
